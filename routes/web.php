...
Route::middleware('auth')->group(function () {
    ...
    */
    Route::prefix('admin')->name('admin.')->group(function () {
        ...
        Route::post('teacher-assignments/{id}/toggle-status', [TeacherAssignmentController::class, 'toggleStatus'])
            ->name('teacher-assignments.toggle-status');
    });
    ...
    Route::get('students/{student}/bform/download', [StudentController::class, 'downloadBForm'])
        ...
        Route::get('/students/{id}/download-photo', [StudentController::class, 'downloadProfilePhoto'])
    ->name('students.photo.download');
...
Route::middleware(['auth'])->prefix('student')->name('student.')->group(function () {
    ...
    Route::post('notifications/mark-latest-read', [NotificationController::class, 'markLatestRead'])
...
Route::prefix('admin')->middleware(['auth'])->name('admin.')->group(function () {
    Route::get('vacations', [AdminVacationRequestController::class, 'index'])->name('vacations.index');
