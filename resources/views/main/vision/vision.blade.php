    ...
    <div class="card about-section">
      ...
      <div class="about-flex">
        ...
        <div class="about-info">
          <h3>Eng. Ahmad Awan</h3><span class="badge">AV (Founder &Owner )</span>
          ...
          <p>At AV, we believe technology should be simple, accessible, and empowering. Our team focuses on creating solutions that are easy to use, time-saving, and result-driven. From small businesses to large enterprises, we aim to help our clients grow by offering tools that enhance productivity, streamline operations, and improve customer engagement.</p>
        </div>
      </div>
    </div>
